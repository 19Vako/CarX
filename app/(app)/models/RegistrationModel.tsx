...
import ContinueWithGmailAndPasswors from "@/app/components/_views/ContinueWithGmailAndPasswors"
import React, { useState } from "react"


export function RegistrationModel() { 
    
    const [activeBottomView, setActiveBottomView] = useState<"Gmail_Password_View" | "Welcome_View">("Welcome_View")
